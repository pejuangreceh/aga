...
class User extends CI_Controller
{
	...
	function save()
	{
		...
		$email = $this->db->query("SELECT email FROM karyawan WHERE nik = '$id_karyawan'")->row();

		$password = trim($this->input->post('password'));
		$id_level = strtoupper(trim($this->input->post('id_level')));
		$password = trim($this->input->post('password'));
		$kantor = trim($this->input->post('kantor'));
		...
		$data['kantor'] = $kantor;
		$data['cabang'] = $cabang;
		$data['jabatan'] = strtoupper(trim($this->input->post('id_jabatan')));
